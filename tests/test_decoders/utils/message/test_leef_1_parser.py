...
#
"""
Unit tests for the LEEF 1.0 parser utility.
...
class TestLEEF1Parser:
    ...
    def test_parse_leef_invalid_format(self):
        ...
        assert LEEF1Parser.parse("Something else") is None
        # Empty message
        assert LEEF1Parser.parse("") is None
        # Incomplete header (fewer than 5 pipes)
        assert LEEF1Parser.parse("LEEF:1.0|IBM|QRadar|1.0") is None
